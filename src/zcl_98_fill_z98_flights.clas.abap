CLASS zcl_98_fill_z98_flights DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
* ENDIF.
    ...
    INSERT Z98_FLIGHTS FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table Z98_FLIGHTS| ).
  ENDMETHOD.
ENDCLASS.
