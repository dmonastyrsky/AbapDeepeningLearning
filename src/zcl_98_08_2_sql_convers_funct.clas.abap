CLASS zcl_98_08_2_sql_convers_funct DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_98_08_2_sql_convers_funct IMPLEMENTATION.
...
*********************************************************************
    DATA(lv_date) = CONV d( '20260108' ).
    " TODO: variable is assigned but never used (ABAP cleaner)
    DATA(today)   = cl_abap_context_info=>get_system_date( ).
    " TODO: variable is assigned but never used (ABAP cleaner)
    DATA(lv_error_handling) = sql_currency_conversion=>c_on_error.
    ...
    SELECT FROM /dmo/travel
      FIELDS total_price,
             ...
             currency_conversion( amount             = total_price,
                                  ...
                                  on_error           = @sql_currency_conversion=>c_on_error-set_to_null ) AS total_price_EUR
